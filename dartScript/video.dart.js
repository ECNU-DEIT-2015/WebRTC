...
(function() {
  ...
  var dart = [["_foreign_helper", "dart:_foreign_helper",, H, {
    ...
    main: [function() {
      var t1, t2;
      t1 = document;
      t2 = J.get$onClick$x(t1.querySelector("#only_video"));
      W._EventStreamSubscription$(t2._html$_target, t2._eventType, new N.main_closure(), false, H.getTypeArgumentByIndex(t2, 0));
      t2 = J.get$onClick$x(t1.querySelector("#mini_video"));
      W._EventStreamSubscription$(t2._html$_target, t2._eventType, new N.main_closure0(), false, H.getTypeArgumentByIndex(t2, 0));
      t2 = J.get$onClick$x(t1.getElementById("recover"));
      W._EventStreamSubscription$(t2._html$_target, t2._eventType, new N.main_closure1(), false, H.getTypeArgumentByIndex(t2, 0));
      t2 = J.get$onClick$x(t1.getElementById("quit"));
      W._EventStreamSubscription$(t2._html$_target, t2._eventType, new N.main_closure2(), false, H.getTypeArgumentByIndex(t2, 0));
      t1 = J.get$onClick$x(t1.getElementById("hidden_local_video"));
      W._EventStreamSubscription$(t1._html$_target, t1._eventType, new N.main_closure3(), false, H.getTypeArgumentByIndex(t1, 0));
    }, "call$0", "video__main$closure", 0, 0, 1],
    main_closure: {
      "^": "Closure:2;",
      call$1: function($event) {
        var t1, videowidth, videoheight, t2, t3;
        t1 = document;
        t1.getElementById("draw_panel").hidden = true;
        t1.getElementById("navigator_div").hidden = true;
        videowidth = window.innerWidth;
        videoheight = window.innerHeight;
        t2 = t1.getElementById("remoteVideo").style;
        t2.position = "absolute";
        t2 = t1.getElementById("localVideo").style;
        t2.position = "absolute";
        t2 = t1.getElementById("remoteVideo").style;
        t3 = J.toString$0$(videowidth) + "px";
        t2.width = t3;
        t2 = t1.getElementById("remoteVideo").style;
        t3 = J.toString$0$(videoheight) + "px";
        t2.height = t3;
        t2 = t1.getElementById("remoteVideo").style;
        t2.top = "0px";
        t2 = t1.getElementById("remoteVideo").style;
        ...
        t2.left = "30px";
        t2 = t1.body;
        t1.documentElement.scrollTop = 0;
        t2.scrollTop = 0;
        P.print("document.body.scrollTop = document.documentElement.scrollTop = 0;");
      }
    },
    main_closure0: {
      "^": "Closure:2;",
      call$1: function(even) {
        var t1, mini_video_width, t2, t3, t4;
        t1 = window.innerWidth;
        if (typeof t1 !== "number")
          return t1.$mul();
        mini_video_width = t1 * 300 / 1366;
        t1 = window.innerHeight;
        if (typeof t1 !== "number")
          return t1.$mul();
        t2 = document;
        t3 = t2.getElementById("remoteVideo").style;
        t3.position = "relative";
        t3 = t2.getElementById("localVideo").style;
        t3.position = "relative";
        t3 = t2.getElementById("remoteVideo").style;
        t4 = window.innerHeight;
        if (typeof t4 !== "number")
          return t4.$negate();
        t4 = C.JSInt_methods.toString$0(-t4) + "px";
        t3.top = t4;
        t3 = t2.getElementById("remoteVideo").style;
        t4 = window.innerWidth;
        if (typeof t4 !== "number")
          return t4.$sub();
        t4 = C.JSNumber_methods.toString$0(t4 - mini_video_width) + "px";
        t3.left = t4;
        t3 = t2.getElementById("remoteVideo").style;
        t4 = C.JSDouble_methods.toString$0(mini_video_width) + "px";
        t3.width = t4;
        t2 = t2.getElementById("remoteVideo").style;
        t1 = C.JSDouble_methods.toString$0(t1 * 3 / 7) + "px";
        t2.height = t1;
      }
    },
    main_closure1: {
      ...
      call$1: function(even) {
        var t1 = document;
        t1.getElementById("draw_panel").hidden = false;
        t1.getElementById("navigator_div").hidden = false;
      }
    },
    main_closure2: {
      "^": "Closure:2;",
      call$1: function(even) {
        P.print("recover");
        H.throwNoSuchMethod("", "context", [], null).callMethod$2("$", ["#icons"]).callMethod$2("fadeToggle", [H.throwRuntimeError("Cannot resolve 'JsObject'.")]);
      }
    },
    main_closure3: {
      "^": "Closure:2;",
      call$1: function(even) {
        var t1;
        P.print("hidden local video");
        t1 = document;
        t1.getElementById("localVideo").hidden = t1.getElementById("localVideo").hidden !== true;
      }
    }
  }, 1]];
  setupProgram(dart, 0);
  ...
  $ = new Isolate();
  init.metadata = [null];
  init.types = [{func: 1}, {func: 1, v: true}, {func: 1, args: [,]}, {func: 1, v: true, args: [{func: 1, v: true}]}, {func: 1, ret: P.String, args: [P.int]}, {func: 1, args: [, P.String]}, {func: 1, args: [P.String]}, {func: 1, args: [{func: 1, v: true}]}, {func: 1, v: true, args: [P.Object], opt: [P.StackTrace]}, {func: 1, args: [,], opt: [,]}, {func: 1, v: true, args: [, P.StackTrace]}, {func: 1, args: [,,]}, {func: 1, args: [P.Symbol0,,]}];
  ...
  (function(callback) {
    ...
    if (typeof dartMainRunner === "function")
      dartMainRunner(function(a) {
        H.startRootIsolate(N.video__main$closure(), a);
      }, []);
    else
      (function(a) {
        H.startRootIsolate(N.video__main$closure(), a);
...
//# sourceMappingURL=video.dart.js.map
